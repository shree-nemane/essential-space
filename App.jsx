      ...
      <section className="py-24 px-6 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-medium text-gray-900 mb-6">One app.</h3>
...
function App() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-gray-900 selection:bg-gray-200 font-['Akshar']">
      <Navbar />
