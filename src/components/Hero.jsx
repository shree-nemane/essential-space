    ...
    <section className="pt-32 pb-20 md:pt-36 md:pb-32 overflow-hidden font-['Akshar']">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="flex-1 relative">
           ...
           <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gray-100 rounded-full blur-3xl opacity-40 -z-10 animate-pulse"></div>
